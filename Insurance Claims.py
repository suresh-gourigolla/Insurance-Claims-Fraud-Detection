...
# MAGIC %sh
# MAGIC mkdir /tmp/insurance_claims
# MAGIC wget https://github.com/mwitiderrick/insurancedata/raw/master/insurance_claims.csv -O /tmp/insurance_claims/insurance_claims.csv

# COMMAND ----------

dbutils.fs.mkdirs("/mnt/insurance_claims/")
dbutils.fs.mv("file:///tmp/insurance_claims/insurance_claims.csv", "/mnt/insurance_claims/insurance_claims.csv")

# COMMAND ----------

data = spark.read.format("csv")\
          .options(inferSchema="true", header="true")\
          .load("/mnt/insurance_claims/insurance_claims.csv")\
          .drop("_c39")\
...
# MAGIC %md We know that feature 9 is our Decision Tree model's root node. Let's see what that corresponds to.
